...
First, for Devart SQLite we need to install [dotConnect for SQLite Professional Trial](https://www.devart.com/dotconnect/sqlite/download.html) to start your 30 days trial period.
